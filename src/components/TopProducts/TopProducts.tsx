...
const TopProducts = ({ handleOrder }: {handleOrder: ()=> void }) => {
  return (
    <div>
      <div  className="container h-[800px] back-products">
        {/* Header section */}
        ...
        {/* Body section */}
        <div data-aos="fade-up"  className="grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-24 md:gap-8 place-items-center">
