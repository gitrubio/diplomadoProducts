                        ...
                        <div className="divide-y divide-gray-200 dark:divide-gray-700">
                            {orders
                                ...
                                <div key={order.id} className="flex flex-wrap items-center gap-y-4 py-6 px-4 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200 rounded-lg">
                                    ...
                                    <div className="w-full sm:w-auto lg:w-auto lg:flex-1">
                                        <div className="flex items-center justify-end gap-4">
                                            <NavLink
                                                to={`/invoice/${order.id}`}
                                                className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                                            >
                                                <svg className="h-3.5 w-3.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
