...
export default function Register() {
   ...
   const { register } = useAuth()
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const data = {
            ...
            password: (e.currentTarget.elements[2] as HTMLInputElement).value,
            confirmPassword: (e.currentTarget.elements[3] as HTMLInputElement).value
        }
        console.log(data);
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center px-4 sm:px-6 py-8 mx-auto min-h-screen">
        ...
        <img alt='none' src={logo} className='h-6 sm:h-8 w-auto' />
